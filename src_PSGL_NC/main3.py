...
# main3 和 main2一样 都是用来做P_A_GIN的任务，二者的区别在于 少了with open，以便比较时间
...
for task in ['link', 'link_pair']:
    ...
    for dataset_name in datasets_name:
        ...
        for repeat in range(args.repeat_num):
            ...
            model = locals()[args.model](num_class=classes, device=device, final_emb_size=final_emb,input_dim=input_dim, feature_dim=args.feature_dim,
            ...
            for epoch in range(args.epoch_num):
                ...
                # for id, data in enumerate(data_list[:effective_len]):
                    ...
                    loss = F.nll_loss(model(data, data_dists_list[id])[data.Node_Classification_Train], data.y[data.Node_Classification_Train])
                ...
                if epoch % args.epoch_log == 0:
                    ...
                    for id, data in enumerate(data_list):
                        ...
                        if bestvalauc<auc_val:
                            ...
                            checkpoint = {'model': locals()[args.model](device = device, num_class=classes,final_emb_size=final_emb, input_dim=input_dim, feature_dim=args.feature_dim,
                            hidden_dim=args.hidden_dim, output_dim=output_dim,
