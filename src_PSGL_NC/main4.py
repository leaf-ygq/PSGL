    ...
    for dataset_name in datasets_name:
        ...
        for repeat in range(args.repeat_num):
            ...
            for i,data in enumerate(data_list):
                ...
                anchorset_ids = preselect_anchor(data, data_dists_list[i], layer_num=args.layer_num, anchor_num=args.anchor_num, device=device)
            ...
            for id, data in enumerate(data_list):
                ...
                plt.xticks([])
                plt.yticks([])
                plt.savefig("./figures/Cora_PGNN.png")
        ...
        with open('epochs/{}_{}_{}.txt'.format(args.task, args.model, dataset_name), 'a') as f:
            f.write('result_mean {}, std {}, num_classes {}\n'.format(results_mean, results_std, classes))
