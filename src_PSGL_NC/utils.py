...
def preselect_anchor(data, data_dists, layer_num=1, anchor_num=32, anchor_size_num=4, device='cpu'):
    ...
    data.dists_max, data.dists_argmax = get_dist_max(anchorset_id, data_dists, device)
    return anchorset_id