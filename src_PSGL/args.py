...
def make_args():
    ...
    # general
    parser.add_argument('--comment', dest='comment', default='1', type=str,
                        help='comment')
    ...
    parser.add_argument('--cuda', dest='cuda', default='3', type=str)
    ...
    parser.add_argument('--anchor_num', dest='anchor_num', default=32, type=int)  #从initial 32
    ...
    parser.add_argument('--Num_Anchors', dest='Num_Anchors', default='32', type=str,
                        help='Num_Anchors') #从logn2改成32
